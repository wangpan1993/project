...
/**
 * Created by WangPan on 2017/12/14.
 */
...
//				Toast.makeText(mContext, "很抱歉,程序出现异常", Toast.LENGTH_LONG).show();
     ...
     * 获取抛出异常的错误信息
     */
    public static String getThrowsInfo(Throwable ex) {
...
//        MobclickAgent.reportError(mContext, ex);// 不知道好使不
        ...
        try {
            ...
            String fileName = "error" + timestamp + ".txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {

                String path = "/sdcard/易考网日志/";
